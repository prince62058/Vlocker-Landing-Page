...
const Signin = ({ onSuccess }: { onSuccess?: () => void }) => {
  ...
  const canSignIn = isOtpComplete && agree && !loading;
      ...
      <div className="container mx-auto">
        <div className="max-w-[500px] mx-auto">
          <div className="bg-tablebg/50 backdrop-blur-xl border border-border rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
            ...
            <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-secondary/10 blur-[80px] rounded-full group-hover:bg-secondary/20 transition-all duration-700"></div>
